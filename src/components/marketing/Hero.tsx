...
const BUTTON_CLASS = "min-w-[240px] h-14 text-lg tracking-wide";
  ...
  <section className="relative flex min-h-screen items-center justify-center overflow-hidden font-sans text-white">
    ...
    <div className="relative z-10 mx-auto grid max-w-6xl grid-cols-1 gap-16 px-6 lg:grid-cols-2">
      <div className="text-center lg:text-left">
        <div className="mb-4">
          <span className="inline-block rounded border border-primary/30 px-4 py-2 font-serif text-sm uppercase tracking-[0.3em] text-primary">
      ...
      <div className="text-center lg:border-l lg:border-white/20 lg:pl-16 lg:text-left">
        <h2 className="mb-8 text-3xl font-light leading-tight lg:text-4xl">
          ...
          <span className="font-serif italic text-primary">Timeless</span> Design
        </h2>
        ...
        <div className="flex flex-col justify-center gap-6 sm:flex-row lg:justify-start">
          <Button size="lg" className={`${BUTTON_CLASS} bg-primary hover:bg-primary/90`} asChild>
            <Link href="/products">View Collection</Link>
          </Button>
          <Button
            size="lg"
            variant="outline"
            className={`${BUTTON_CLASS} border-2 border-white/20 text-foreground-700 hover:border-white hover:bg-white/10 hover:text-white`}
            asChild
          >
