            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-gray-400 font-light max-w-3xl mx-auto leading-relaxed">
                        A glimpse into the future of luxury furniture. Each piece is a masterpiece in waiting.
                    </p>
                ...
                <div className="grid md:grid-cols-3 gap-12 mb-24">
                    {collections.map((collection, index) => (
                        ...
                        >
                            <div className={`absolute inset-0 bg-gradient-to-b ${collection.gradient} opacity-0 group-hover:opacity-100 transition-all duration-700 rounded-2xl`} />
