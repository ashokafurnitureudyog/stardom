...
const SocialConnect = () => {
  ...
  return (
    <section className="bg-linear-to-b from-black via-zinc-900 to-black py-32 text-center font-sans">
      <div className="container mx-auto px-4">
        <div className="relative mb-16">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 w-24 h-px bg-linear-to-r from-transparent via-gold-400 to-transparent"></div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {socialLinks.map((social) => (
            <a
              key={social.label}
              href={social.href}
              className="group relative overflow-hidden rounded-xl bg-linear-to-br from-zinc-900 to-zinc-800 p-8 transition-all duration-500 hover:from-zinc-800 hover:to-zinc-700"
            >
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 bg-linear-to-r from-gold-300 via-transparent to-gold-300" />
            </a>
          ))}
        </div>
