      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-24">
          ...
          >
            ...
            Since 1996, Ashoka Furniture Udyog has been crafting exceptional furniture pieces. 
                            In 2014, we embarked on a new journey with Stardom, elevating our legacy of craftsmanship 
          ...
          >
            <div className="flex gap-8">
                            <div>
                                <div><NumberTicker value={27} className="text-5xl md:text-6xl text-white font-light mb-4" /></div>
                                <div className="text-lg text-gray-400 font-light tracking-wide">Years of Excellence</div>
                            </div>
                            <div>
                            <div><NumberTicker value={9} className="text-5xl md:text-6xl text-white font-light mb-4" /></div>
                                <div className="text-lg text-gray-400 font-light tracking-wide">Years as Stardom</div>
                            </div>
                        </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-gray-400 font-light">
            Stardom is more than furniture; it&apos;s an embodiment of sophisticated living. 
                            Each piece is meticulously crafted, marrying time-honored artisanship 
