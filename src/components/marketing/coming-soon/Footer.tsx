        ...
        <footer className="bg-black text-gray-400 py-20 font-sans relative">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className="text-white mb-6 text-sm font-semibold tracking-widest">QUICK LINKS</h4>
                    ...
                    {/* Contact Info */}
                    <div>
                        <h4 className="text-white mb-6 text-sm font-semibold tracking-widest">CONTACT</h4>
                    ...
                    {/* Legal Links */}
                    <div>
                        <h4 className="text-white mb-6 text-sm font-semibold tracking-widest">LEGAL</h4>
                        <nav className="space-y-4">
                            {legalLinks.map((link) => (
                                <a
                                    key={link.label}
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-sm tracking-wide">© 2024 Stardom. All rights reserved.</p>
