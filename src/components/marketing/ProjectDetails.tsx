...
import type { ProjectDetailsProps } from "@/types/ComponentTypes";

export const ProjectDetails = ({ project, open, onClose }: ProjectDetailsProps) => {
              ...
              <div className="flex flex-col md:flex-row gap-16 items-start">
                <section className="flex-1 group">
                  <div className="mb-6 flex items-center space-x-2">
                    ...
                    <h3 className="text-2xl font-serif tracking-tight">The Challenge</h3>
                  </div>
              ...
              <div className="flex flex-col md:flex-row-reverse gap-16 items-start">
                <section className="flex-1 group">
                  <div className="mb-6 flex items-center space-x-2">
                    ...
                    <h3 className="text-2xl font-serif tracking-tight">Our Solution</h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed group-hover:text-foreground transition-colors">
                    {project.solution}
                  </p>
              ...
              <div className="flex flex-col md:flex-row gap-16 items-start">
                <section className="flex-1 group">
                  <div className="mb-6 flex items-center space-x-2">
                    ...
                    <h3 className="text-2xl font-serif tracking-tight">The Impact</h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed group-hover:text-foreground transition-colors">
                    {project.impact}
                  </p>
